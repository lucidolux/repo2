...
insert into perros(nombre,raza,edad,v_parvovirus,v_moquillo,v_adenovirus,v_hepatitis,v_rabia,esterilizacion,peso,genero,fechaIngreso,idVeterinario,adopcion,idResponsable,fechaAdopcion)
values 		
	 ...
	 ('sam','chiwawa',7,'si','si','si','si','si','no esteri',23,'macho','2015-01-03',2,'adoptado',3,'2016-01-19'),
	 ('frodo','pastor aleman',8,'si','no','si','si','no','no esteri',25,'macho','2014-01-03',3,'adoptado',4,'2015-05-11'),
         ('aragorn','shar pei',4,'si','no','no','no','si','esterilizado',11,'macho','2018-03-19',5,'adoptado',5,'2018-10-19'),
         ('vaya de oro','bull dog',1,'si','si','no','si','si','no esteri',12,'hembra','2018-05-14',4,'adoptado',6,'2018-05-09'),
         ('guachin','pastor blanco zuizo',12,'si','si','si','si','si','esterilizado',16,'macho','2011-12-05',3,'adoptado',7,'2016-02-02'),
         ('ficus','chow choyw panda',7,'si','no','no','no','si','no esteri',12,'macho','2016-06-06',5,'adoptado',8,'2016-07-19'),
         ('superdog','labrador',5,'si','no','si','si','no','esterilizado',17,'macho','2015-01-01',5,'no adopt',null,null),
         ('legolas','doberman',9,'si','no','si','si','si','no esteri',26,'macho','2012-04-17',4,'adoptado',9,'2014-9-18'),
         ('fito','mestizo',3,'no','no','no','no','no','no esteri',1,'macho','2018-12-03',5,'no adopt',null,null),
         ('luna','bull terrier',3,'no','no','no','no','no','no esteri',6,'hembra','2016-04-06',1,'adoptado',10,'2018-12-31'),
	 ('nube','grifon',7,'si','si','si','si','si','esterilizado',10,'hembra','2014-07-15',1,'adoptado',11,'2014-11-20'),
         ...
         ('piel roja','mestizo',16,'si','si','si','si','si','esterilizado',17,'macho','2009-09-11',3,'no adopt',null,null),
         ('pulgas','jack russell',8,'no','no','no','no','no','no esteri',12,'macho','2013-01-05',4,'adoptado',10,'2014-08-04'),
         ('morcilla','bernes',3,'si','no','no','si','no','no esteri',12,'hembra','2018-09-24',5,'no adopt',null,null),
  	 ('tinto','pastor blanco suizo',6,'si','no','si','si','si','esterilizado',16,'macho','2016-02-27',3,'adoptado',3,'2017-04-30'),
         ...
         ('mordor','dalmata',6,'no','no','no','no','no','no esteri',16,'macho','2015-08-04',2,'no adopt',null,null),
         ('saruman','pinsher miniatura',7,'si','si','si','si','no','no esteri',4,'macho','2015-11-11',4,'no adopt',null,null),
         ('gollum','mastin',7,'no','no','no','no','no','no esteri',20,'macho','2014-12-02',5,'adoptado',8,'2016-10-21'),
         ('marley','podenco andaluz',3,'si','no','no','no','no','no esteri',3,'hembra','2018-01-15',5,'adoptado',9,'2018-10-25'),
         ...
         ('agua','sabueso del tirol ',3,'no','no','no','no','no','no esteri',5,'hembra','2017-08-01',2,'no adopt',null,null),
         ('wally','mestizo',1,'no','no','no','no','no','no esteri',4,'macho','2019-04-01',4,'no adopt',null,null);
 select * from perros;
                  
 
 
 insert into gatos   (nombre,raza,edad,v_trivalente,v_leucemia,v_rabia,esterilizado,peso,genero,f_ingreso,idVeterinario,adopcion,idResponsable,f_adopcion)
 values
	('michico','mestizo',4,'no','no','no','no esteri',4.2,'macho','2016-09-08',1,'no adopt',null,null),
	('micky','mestizo',4,'no','no','no','no esteri',4.9,'macho','2016-09-08',1,'adoptado',1,'2018-06-11'),
	...
	('cortna','metizo',6,'no','si','no','no esteri',4.6,'macho','2014-12-09',4,'no adopt',null,null),
        ('chavo','egipcio',2,'no','no','no','no esteri',2.2,'macho','208-09-07',2,'adoptado',5,'2019-06-15'),
	('dino','bengala',7,'si','si','si','esterilizado',5.1,'macho','2016-02-04',3,'adoptado',6,'2018-09-17'),
        ...
        ('buho','maine coon',3,'no','si','si','no esteri',4.0,'macho','2018-12-23',3,'no adopt',null,null),
        ('tom','ragdoll',2,'no','no','no','no esteri',3.2,'macho','2017-11-18',2,'adoptado',7,'2018-07-19'),
        ('jerry','sphynx',5,'si','no','no','esterilizado',4.3,'macho','2017-01-02',3,'adoptado',8,'2017-06-15'),
        ('thor','siames',7,'si','si','si','esterilizado',5.3,'macho','2013-03-05',4,'no adopt',null,null),
        ...
        ('bombon','himalayo',4,'si','no','no','no esteri',4.2,'hembra','2015-01-02',3,'adoptado',10,'2016-07-04'),
        ('jerry','sphynx',5,'si','no','no','esterilizado',4.3,'macho','2018-03-03',1,'adoptado',11,'2019-05-14'),
        ('neo','bombay',2,'si','si','si','no esteri',4.9,'macho','2018-11-12',2,'no adopt',null,null),
        ('roca','sphynx',1,'no','no','no','no esteri',1,'macho','2019-01-01',3,'no adopt',null,null),
        ...
        ('je','sphynx',2,'si','si','no','no esteri',3.1,'macho','2018-04-03',1,'adoptado',3,'2019-05-11'),
        ('ajo','peterbald',4,'si','si','si','no esteri',3.3,'hembra','2019-05-04',2,'adoptado',4,'2019-07-31');
  select * from gatos;      